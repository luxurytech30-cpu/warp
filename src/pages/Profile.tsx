    ...
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-black mb-8">
          הפרופיל <span className="text-gradient-primary">שלי</span>
        </h1>
          ...
          <div className="lg:col-span-1">
            <Card className="p-8 shadow-premium text-center">
              ...
              <Badge className="gradient-gold text-white">
                {user?.role === "admin" ? "מנהל" : "לקוח רשום"}
              </Badge>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-lg text-muted-foreground">
                    עדיין לא ביצעת הזמנה.
                    <br />
                    ברגע שתבצע רכישה – היא תופיע כאן.
                  </p>
                </div>
              ) : (
                  ...
                  <table className="w-full text-sm text-right border-collapse">
                    <thead>
                      <tr className="border-b text-xs text-muted-foreground">
                        <th className="py-2 px-2">מס׳ הזמנה</th>
                        <th className="py-2 px-2">תאריך</th>
                        <th className="py-2 px-2">פריטים</th>
                  ...
                  {selectedOrder.items.map((item, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground">
                            {item.optionName} · כמות: {item.quantity}
                          </div>
                        </div>
                      </div>
                      <div className="text-sm font-semibold">
                        ₪
                        {(
                          item.priceWithoutMaam * item.quantity
                        ).toFixed(2)}
                      </div>
                    </div>
                  ))}
                ...
                <div className="border-t pt-4 space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-primary">
                      ₪
                      {(
                        selectedOrder.totalWithMaam -
                        selectedOrder.totalWithoutMaam
                      ).toFixed(2)}
                    </span>
                  </div>
